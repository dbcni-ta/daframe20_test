...
function setHeader(GridObj) {		  
	...
	// 콤보정보를 JS를 사용해서 세팅한다.
	// 동적으로 처리할 경우 JSP 상에서 스크립틀릿을 활용해 아래의 구문을 for 문등으로 처리한다.
	GridObj.AddComboListValue("NATION_CODE", "호주", "AUS");
	GridObj.AddComboListValue("NATION_CODE", "스페인", "ESP");
	GridObj.AddComboListValue("NATION_CODE", "독일", "GRE");
	GridObj.AddComboListValue("NATION_CODE", "한국", "KOR");
	GridObj.AddComboListValue("NATION_CODE", "미국", "USA");
}
...
function doQuery() {
	...
	comQuery.setGridUrl("WISE200.R01.cmd");
...
function doSave() {
	...
	var comQuery = new CommonQuery();
	comQuery.setGridUrl("WISE200.X01.cmd");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="20">
    <td class="title2_k">
			콤보의 코드설정을 클라이언트단에서 설정한 방식 (쉽지만 콤보정보노출)
    </td>
  </tr> 
</table>
<hr>
