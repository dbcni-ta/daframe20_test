...
function doQuery() {
	...
	comQuery.setGridUrl("WISE100.R01.cmd");
...
function doSave() {
	...
	var comQuery = new CommonQuery();
	comQuery.setGridUrl("WISE100.X01.cmd");
	comQuery.addGridObj("WiseGrid","CRUD"); // CRUD 방식이며, CRUD 컬럼이 정의되어 있는 상태이고, GridObj.SetCRUDMode() 가 정의되어 있어야한다.
